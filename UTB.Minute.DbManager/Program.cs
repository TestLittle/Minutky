...
app.MapPost("/reset-db", async (MinuteContext context) =>
{
    ...
    MinuteMeal cheese = new() { Desc = "Smazeny syr s hranolkami", Price = 124.99, IsActive = true};
    MinuteMeal hamburger = new() { Desc = "Hamburger", Price = 139.99, IsActive = true };
    MinuteMeal hamPizza = new() { Desc = "Sunkova Pizza", Price = 109.99, IsActive = true };
